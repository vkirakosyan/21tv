                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name in English </th><td> {{ $category->name_en }} </td></tr>
                                    <tr><th> Name in Russian </th><td> {{ $category->name_ru }} </td></tr>
                                    <tr><th> Name in Armenian </th><td> {{ $category->name_am }} </td></tr>
                                </tbody>
                            </table>
                        </div>
